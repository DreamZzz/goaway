package com.goaway.contexts.media.application;

import com.aliyun.oss.OSS;
import com.aliyun.oss.model.CannedAccessControlList;
import com.aliyun.oss.model.ObjectMetadata;
import com.aliyun.oss.model.PutObjectRequest;
import com.goaway.platform.config.OssConfig.OssProperties;
...
public class FileStorageService {
    ...
    public String storeFile(MultipartFile file, Long ownerId) {
        return storeFileWithDescriptor(file, ownerId).getStorageKey();
    }

    public StoredFileDescriptor storeFileWithDescriptor(MultipartFile file, Long ownerId) {
        ...
        try {
            ...
            return new StoredFileDescriptor(
                    fileName,
                    getFileUrlFromFileName(fileName),
    ...
    private PreparedUpload prepareManagedUpload(byte[] data, String contentType) throws IOException {
        ...
        if (VIDEO_EXTENSIONS.containsKey(normalizedContentType)) {
            return new PreparedUpload(
                    ...
                    VIDEO_EXTENSIONS.get(normalizedContentType)
            );
        }
