...
class UserControllerTest {
    ...
    @MockBean
    private com.goaway.contexts.account.application.GuestSessionService guestSessionService;

    @MockBean
    private com.goaway.platform.security.GuestSecuritySupport guestSecuritySupport;
