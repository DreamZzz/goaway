...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  func application(
    ...
    // Must be assigned before launch finishes so cold-start notification
    // taps are delivered; JS pulls them later via getInitialNotification().
    UNUserNotificationCenter.current().delegate = LocalNotificationTapStore.shared
